...
<body>
    ...
    <a href="{{ url('customer')}}"><button>Customer View</button></a>
            ...
            @foreach ($customers as $customer)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('customer.force-delete', ['id' => $customer->customers_id]) }}"><button
                                class="btn btn-danger">Delete</button></a>
                        <a href="{{ route('customer.restore', ['id' => $customer->customers_id]) }}"><button
